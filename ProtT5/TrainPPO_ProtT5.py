...
# 全部数据集
test_negative = "../Dataset/test/features/test_negative_ProtT5_features_K.csv"
test_positive = "../Dataset/test/features/test_positive_ProtT5_features_K.csv"
train_negative = "../Dataset/train/features/train_negative_ProtT5_features_K.csv"
train_positive = "../Dataset/train/features/train_positive_ProtT5_features_K.csv"

X_train, y_train, X_test, y_test, ratio = GetProtT5_K_4(train_negative, train_positive, test_negative, test_positive)
...
# 保存模型参数
torch.save(policy_module.state_dict(), f'Models/{model_name}_ACC{Acc:.4f}_MCC{MCC:.4f}_SN{Sn:.4f}_SP{Sp:.4f}.pth')
