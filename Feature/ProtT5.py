...
N_input_file_path = '../MyData/All_NegativeSites_CD.fasta'
N_output_file_path = '../MyData/All_NegativeSites_CD_ProtT5_features.csv'

P_input_file_path = '../MyData/All_PositiveSites_CD.fasta'
P_output_file_path = '../MyData/All_PositiveSites_CD_ProtT5_features.csv'
